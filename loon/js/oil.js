/**
 * 原来作者：fmz200，修改自Toperlock的oil_price.js
 * 作用：定时查询油价
...
function getRegion() {
  if (typeof $prefs !== "undefined") {
    return $prefs.valueForKey('oil_price_region') || "zhejiang"; // QuantumultX
  } else if (typeof $persistentStore !== "undefined") {
    return $persistentStore.read('oil_price_region') || "zhejiang"; // Loon
  } else {
    return "zhejiang"; // 默认值
  }
}
