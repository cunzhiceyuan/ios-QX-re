...
[rewrite_local]
^https:\/\/flomoapp\.com\/api\/v1\/user\/me url script-analyze-echo-response https://raw.githubusercontent.com/cunzhiceyuan/ios-QX-re/refs/heads/main/loon/js/flomo%2Cjs
...
$done(isQuanX ? response : { response })l
