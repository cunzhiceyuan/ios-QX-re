...
//1: fastraw.ixnic.net 2.hub.incept.pw 3.raw.kkgithub.com  4.mirror.ghproxy.com
...
else if (changeTo == "E镜像") {
    headers["host"] = "mirror.ghproxy.com"
    url = url.replace(githubPrefix,mirrorghproxy)
}
